  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
        {/* Image */}
        <div
          className="rounded-2xl flex items-center justify-center h-80 lg:h-full min-h-72"
          style={{ background: "linear-gradient(135deg, #f0f4f8 0%, #e4ecf6 100%)" }}
        >
          <div className="text-center">
            <div
              className="w-24 h-24 rounded-3xl flex items-center justify-center opacity-20 mx-auto mb-3"
            ...
            <p className="text-xs text-gray-400">Productafbeelding volgt</p>
          </div>
        </div>
