          ...
          {STORES.map((store, i) => (
            ...
            >
              ...
              <div className="px-5 py-4">
                ...
                {/* Onderste rij: voorraad, levering, verkoper, op tijd */}
                <div className="mt-3 pt-3 border-t border-gray-100 flex flex-wrap gap-x-5 gap-y-1.5">
                  ...
                  <span className="flex items-center gap-1.5 text-xs text-gray-500">
                    ...
                    Verkocht door: <strong className="text-gray-700">{store.seller}</strong>
                  </span>
                  <span className="flex items-center gap-1.5 text-xs text-gray-500">
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ color: "#173441" }}>
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    Op tijd geleverd: <strong className="text-gray-700">{store.onTime}%</strong>
                  </span>
                </div>
              </div>
            </div>
