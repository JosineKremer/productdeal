...
const STORES = [
  { name: "SportsDirect", price: "€ 23,99", originalPrice: null, delivery: "Gratis verzending", url: "#", rating: 4.5, reviews: 1204 },
  { name: "Zalando", price: "€ 26,95", originalPrice: null, delivery: "Gratis bezorging · 100 dagen retour", url: "#", rating: 4.7, reviews: 8921 },
  { name: "bol.com", price: "€ 27,99", originalPrice: null, delivery: "Gratis bezorging morgen", url: "#", rating: 4.6, reviews: 15203 },
];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6">
      ...
      <section className="mb-10">
        <h2 className="text-xl font-bold mb-4" style={{ color: "#173441" }}>Specificaties</h2>
