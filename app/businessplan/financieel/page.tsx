    ...
    <div className="flex flex-col min-h-full bg-lin">
      ...
      <section className="relative flex flex-col items-center justify-center text-center px-6" style={{ minHeight: "50vh", paddingTop: "52px", background: "#2C2A25" }}>
        ...
        <p className="font-sans text-lin/40 uppercase font-light" style={{ fontSize: "10px", letterSpacing: "0.35em" }}>
          NOORD Social Recovery Club · 2025–2027
        </p>
      ...
      <section className="bg-wit py-24 px-6" style={{ borderTop: "0.5px solid #C8BAA8" }}>
        <div className="max-w-5xl mx-auto">
          ...
          <p className="font-sans font-light mb-16 leading-relaxed" style={{ fontSize: "15px", color: "#5C5248", maxWidth: "600px" }}>
            De totale investering bestaat uit de aankoop van het pand (waardevast actief) en de operationele investering. Alleen de operationele investering moet worden terugverdiend uit de exploitatie.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-16 mb-12">
            <div>
              ...
              {[
                ...
                { post: "Magnesiumjacuzzi", bedrag: "€22.000 – €35.000", note: "Buiten, 8–10 personen, magnesiumchloride systeem, 38°C" },
          ...
          <div className="grid md:grid-cols-3 gap-[2px]" style={{ background: "#C8BAA8" }}>
            {[
              ...
              { label: "Operationele investering", amount: "€580.000 – €775.000", sub: "Verbouwing, installaties, inrichting, opstart", dark: false },
              { label: "Onvoorzien (10%) + totaal", amount: "€1.200.000 – €1.600.000", sub: "All-in investering inclusief 10% buffer", dark: false },
            ].map((c) => (
      ...
      <section className="bg-lin py-24 px-6" style={{ borderTop: "0.5px solid #C8BAA8" }}>
        <div className="max-w-5xl mx-auto">
          ...
          <p className="font-sans font-light mb-16 leading-relaxed" style={{ fontSize: "15px", color: "#5C5248", maxWidth: "600px" }}>
            NOORD werkt met tijdslots van 3 uur — geen hele-dag-toegang. Weekdagen open vanaf 12:00 (3 slots), weekenden vanaf 09:00 (4 slots).
          </p>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-[2px]" style={{ background: "rgba(242,237,230,0.06)" }}>
            <div className="p-8" style={{ background: "rgba(242,237,230,0.04)" }}>
              ...
              <div className="font-sans font-light text-lin/30 mt-2" style={{ fontSize: "12px" }}>Excl. pand — terug te verdienen uit exploitatie</div>
            </div>
            <div className="p-8" style={{ background: "rgba(242,237,230,0.04)" }}>
      ...
      <div className="bg-eiken py-6 px-6" style={{ borderTop: "0.5px solid rgba(242,237,230,0.08)" }}>
        <div className="max-w-5xl mx-auto">
          <p className="font-sans font-light leading-relaxed" style={{ fontSize: "13px", color: "rgba(242,237,230,0.45)", maxWidth: "700px" }}>
            Lage bezoekersprognoses, soberdere investeringen en een kleinere personeelsbezetting die meegroeit met de omzet. De duurzaamheidspijlers en het pand blijven ongewijzigd.
          </p>
        </div>
      </div>
      ...
      <section className="bg-wit py-24 px-6" style={{ borderTop: "0.5px solid #C8BAA8" }}>
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-16 mb-12">
            <div>
              ...
              {[
                ...
                { post: "Magnesiumjacuzzi", bedrag: "€14.000 – €22.000", note: "Standaard model buiten, magnesiumchloride systeem, 8–10 personen" },
          ...
          <div className="grid md:grid-cols-3 gap-[2px]" style={{ background: "#C8BAA8" }}>
            {[
              { label: "Aankoop pand", amount: "€550.000 – €750.000", sub: "Waardevast actief, buiten exploitatie-rendement", dark: true },
              { label: "Operationele investering", amount: "€265.000 – €420.000", sub: "Verbouwing, installaties, inrichting, opstart", dark: false },
              { label: "Onvoorzien (10%) + totaal", amount: "€840.000 – €1.215.000", sub: "All-in investering inclusief 10% buffer", dark: false },
            ].map((c) => (
              <div key={c.label} className={`p-8 ${c.dark ? "bg-nacht" : "bg-wit"}`}>
                <div className="font-sans font-light uppercase mb-3" style={{ fontSize: "9px", letterSpacing: "0.3em", color: c.dark ? "rgba(242,237,230,0.3)" : "#C8BAA8" }}>{c.label}</div>
                <div className="font-serif font-light" style={{ fontSize: "clamp(16px, 2vw, 22px)", letterSpacing: "0.03em", color: c.dark ? "#D4A878" : "#A07040" }}>{c.amount}</div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 p-6" style={{ background: "#F5F1EB", border: "0.5px solid #C8BAA8" }}>
            <p className="font-sans font-light leading-relaxed" style={{ fontSize: "13px", color: "#5C5248" }}>
              <span className="font-medium text-nacht">Conclusie.</span> Zelfs in het conservatieve scenario — met de helft van de bezoekers en veel lagere kosten — is NOORD financieel haalbaar. De lage break-even (~380 gasten/mnd, 15% van de maximumcapaciteit) biedt een stevige veiligheidsmarge. De operationele investering is in beide scenario&apos;s terugverdiend binnen 4 jaar. Het pand is in beide gevallen een waardevast actief.
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-nacht" style={{ borderTop: "0.5px solid rgba(242,237,230,0.06)" }}>
        <div className="max-w-5xl mx-auto px-6 lg:px-14 py-12 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          ...
          <p className="font-sans font-light text-lin/20" style={{ fontSize: "11px" }}>
            Vertrouwelijk document · Uitsluitend voor investeerders · © 2025 NOORD Social Recovery Club
          </p>
        </div>
      </footer>
